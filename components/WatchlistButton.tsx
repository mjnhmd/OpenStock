...
const WatchlistButton = ({
    ...
    if (type === "icon") {
        return (
            <button
                type="button"
                title={added ? `将 ${symbol} 移出自选` : `将 ${symbol} 加入自选`}
                aria-label={added ? `将 ${symbol} 移出自选` : `将 ${symbol} 加入自选`}
